...
////movimento remprestimo por data de pagamento
export const movimentoEmprestimoPagamento = (req, res) => {
    var { dataI } = req.body;
    var { dataF } = req.body;
...
/////relatorios moviemto de cheque por data de vencimento
export const movimentoChequesPorPagamento = (req, res) => {
    const { dataI } = req.body;
    const { dataF } = req.body;
    const { status } = req.body;
